...
class _base(tcfl.tc.tc_c):
    ...
    """
    def start(self):
        for _twn, target in list(self.targets.items()):
            target.power.cycle()
    ...
    def eval_targets_are_up(self):
        # Each target is up
        for twn, target  in list(self.targets.items()):
            if twn == 'ic':
                continue
    ...
    def eval_targets_can_ping_eachother(self):
        ...
        for twna, targeta in list(self.targets.items()):
            if twna == 'ic':
                continue
            for twnb, targetb in list(self.targets.items()):
                if twnb == 'ic':
                    continue
